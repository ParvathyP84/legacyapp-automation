...
public class IOSTabletHomePage extends HomePage{
	...
	public String[] findChildObject(String reqLocatorName){	
		Field childObjects;
		try {
			childObjects = IOSTabletHomePage.class.getDeclaredField(reqLocatorName);
		
		String[] childObject;
		String[] objForChild={"","",""};
		if(childObjects.getType().isInstance(objForChild)){
			childObject=(String[]) (IOSTabletHomePage.class.getDeclaredField(reqLocatorName).get(null));
			return childObject;
		}
