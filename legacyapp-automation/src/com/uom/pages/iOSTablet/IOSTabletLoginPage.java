...
public class IOSTabletLoginPage extends LoginPage {
	...
	public String[] findChildObject(String reqLocatorName){
		Field childObjects;
		try {
			childObjects = IOSTabletLoginPage.class.getDeclaredField(reqLocatorName);
		
		String[] childObject;
		String[] objForChild={"","",""};
		if(childObjects.getType().isInstance(objForChild)){
			childObject=(String[]) (IOSTabletLoginPage.class.getDeclaredField(reqLocatorName).get(null));
			return childObject;
		}
